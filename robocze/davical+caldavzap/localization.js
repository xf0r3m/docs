...
localization['pl_PL']=	/* xf0r3m <jakubstasinski@protonmail.com> */
{
	txtResources: 'Zasoby',
	txtNote: 'Notka',

	errUnableSync: 'Błąd: \'synchronizacja zasobów jest obecnie niemożliwa\': spróbuj ponownie poźniej!',

	loadingResources: 'Ładowanie zasobów (%act% z %total%) ...',
	loadingCollectionList: 'Ładowanie listy zasobów',

	txtCacheText: 'Dostępna jest aktualizacja na serwerze, proszę załadować ponownie stronę!',
	txtCacheButton: 'Załaduj ponownie'
};
...
localizationShared['pl_PL']=	/* xf0r3m <jakubstasinski@protonmail.com> */
{
	_name_: 'Polski',
	_default_datepicker_format_: 'dd.mm.yy',
	_default_AMPM_format_: false,
	...
	pholderUsername: 'Nazwa użytkownika',
	pholderPassword: 'Hasło',
	txtSearch: 'Szukaj',
	txtError: 'Błąd',
	txtRefresh: 'Odświerz',
	...
	errCollectionLoad: 'Błąd: \'zapisanie ustawień jest niemożliwe\'!',
	errHttpCommon: 'Kod błędu %%',
	errHttp401: 'Nieautoryzowany',
	errHttp403: 'Zabroniony',
	errHttp405: 'Niedozwolona metoda',
	errHttp408: 'Przekroczono limit czasu',
	errHttp412: 'Ktoś właśnie zmienił to na serwerze',
	errHttp500: 'Wewnętrzny błąd serwera',
	errHttp501: 'Nie zaimplementowano',

	unsupportedBrowser: 'Uwaga: nieobsługiwana przeglądarka!',
	updateNotification: '%name% %new_ver% jest dostępna (Obecnie używana %curr_ver%) - %url%'
};
...
localizationSharedCalDAV['pl_PL']=	/* xf0r3m <jakubstasinski@protonmail.com> */
{
	txtCalendars: 'Kalendarze',
	txtTodos: 'ToDo',
	localTime: 'Czas lokalny',
	fullCalendarMonth: 'miesiąc',
	fullCalendarMultiWeek: 'wiele tygodni',
	fullCalendarAgendaWeek: 'tydzień',
	fullCalendarAgendaDay: 'dzień',
...
localizationCalDAV['pl_PL']=	/* xf0r3m <jakubstasinski@protonmail.com> */
{
	_default_title_format_month_: 'MMM yyyy',
	_default_title_format_week_: 'd[ MMM][ yyyy]{ \'–\' d MMM yyyy}',
	_default_title_format_day_: 'ddd, d MMM yyyy',
	...
	txtCalendar: 'Kalendarz',
	txtEnabledCalendars: 'Włączone kalendarze',
	txtTodo: 'ToDo',
	txtTodoList: 'List ToDo',
	txtTodoLists: 'Listy ToDo',
	txtEnabledTodoLists: 'Włączone listy ToDo',
	txtSubscribed: 'Subskrypcje',
	fullCalendarTable: 'Table',
	fullCalendarTodayButton: 'Dziś',
	fullCalendarAllDay: 'Cały dzień',
	CalDAVsearch: 'Szukaj',
	resourceEnable: 'Włacz wszystkie kalendarze w tym zasobie',
	resourceDisable: 'Wyłącz wszystkie kalendarze w tym zasobie',
	allEnable: 'Włacz wszystkie kalendarze',
	allDisable: 'Wyłącz wszystkie kalendarze',
	timezone: 'Strefa czasowa',
	txtTimezonePicker: 'Strefa czasowa:',
	loadingRList: 'Ładowanie listy zasobów ...',
	renderingE: 'Renderowanie kalendarzy ...',
	timezoneChange: 'Zatwierdzanie zmiany strefy czasowej ...',
	customTimezone: 'Dostosowany (Czas lokalny)',
	customRepeat: 'Inny (modyfikacje niewspierane)',
	loadPrevMonth: 'Załaduj poprzedni miesiąc',
	loadNextMonth: 'Załaduj następny miesiąc',
	repeatBoxButton: 'Rekurencja',
	repeatBoxContent: 'Powtarzalne wydarzenie',
	repeatBoxQuestion: 'Które wydarzenie chcesz zmienić?',
	allEvsButton: 'Wszystkie wydarzenia',
	allFutureButton: 'To i wszystkie przyszłe wydarzenia',
	eventOnlyButton: 'Tylko to wydarzenie',
	repeatBoxContentTODO: 'To powtarzalne zadanie ToDo.',
	repeatBoxQuestionTODO: 'Które zadanie ToDo chcesz zmienić?',
	allEvsButtonTODO: 'Wszystkie zadania ToDo',
	allFutureButtonTODO: 'To i wszystkie przyszłe zadania ToDo',
	eventOnlyButtonTODO: 'Tylko to zadanie ToDo',
	txtStatus: 'Status',
	eventAvailability : 'Dostępny',
	eventAvailabilityBusy : 'Zajęty',
	eventAvailabilityFree : 'Wolny',
	eventType: 'Prywatność',
	eventTypePublic: 'Publiczny',
	eventTypePrivate: 'Prywatny',
	eventTypeConfidential: 'Poufny',
	txtPriority: 'Priorytet',
	txtPriorityNone: 'Nieokreślony',
	txtPriorityLow: 'Niski',
	txtPriorityMedium: 'średni',
	txtPriorityHigh: 'Wysoki',
	eventURL : 'URL',
	repeatInterval: 'kazdego',
	repeatDays: 'dnia',
	repeatWeeks: 'tygodnia',
	repeatMonths: 'miesiąca',
	repeatYears: 'roku',
	repeatChangeTxt: 'zostało zmienione na serwerze!',
	repeatChangeTxtClose: 'Zamknij formularz i otwórz wydarzenie ponownie',
	repeatTodoChangeTxtClose: 'Zamknij formularz i otwórz zadanie ToDo ponowi',
	calendarLoader: 'Ladowanie ponowne ...',
	resizeLoader: 'Zmiana rozmiaru ...',

	// TODOS
	pholderNameTODO: 'Nazwa',
	pholderNewTODO: 'Nowe zadanie ToDo',
	txtTypeTODO: 'Typ',
	txtTypeTODONone: 'Proste',
	txtTypeTODOStart: 'Z czasem początkowym',
	txtTypeTODODue: 'Z czasem oddania',
	txtTypeTODOBoth: 'Z czasem początkowym oraz oddania',
	txtDateFromTODO: 'Od',
	txtDateToTODO: 'Do',
	txtCompletedOn: 'Ukończono',

	pholderDateFromTODO: 'Od dnia',
	pholderTimeFromTODO: 'Od godziny',
	pholderDateToTODO: 'Do dnia',
	pholderTimeToTODO: 'Do godziny',
	pholderCompletedOnDate: 'Data',
	pholderCompletedOnTime: 'Czas',

	txtStatusFiltersHeaderTODO: 'Filtry',
	txtStatusFiltersFooterTODO: '* ukończono w lub po %date%',
	txtStatusNeedsActionTODO: 'Wymaga uwagi',
	txtStatusCompletedTODO: 'Ukończono',
	txtStatusInProcessTODO: 'W trakcie',
	txtStatusCancelledTODO: 'Anulowano',
	txtPercentCompletedTODO: 'Ukończono',

	txtCalendarTODO: 'Kalendarz',
	txtSelectCalendarTODO: 'Wybierz kalendarz',
	txtAlertTODO: 'Ostrzeżenie',
	txtAlertNoneTODO: 'Nieokreślone',
	txtAlertMessageTODO: 'Wiadomość',
	txtAlertOnDateTODO: 'Data',
	txtAlertWeeksBeforeTODO: 'Tygodni przed',
	txtAlertDaysBeforeTODO: 'Dni przed',
	txtAlertHoursBeforeTODO: 'Godzin przed',
	txtAlertMinutesBeforeTODO: 'Minut przed',
	txtAlertSecondsBeforeTODO: 'Sekund przed',
	txtAlertWeeksAfterTODO: 'Tygodni po',
	txtAlertDaysAfterTODO: 'Dni po',
	txtAlertHoursAfterTODO: 'Godzin po',
	txtAlertMinutesAfterTODO: 'Minut po',
	txtAlertSecondsAfterTODO: 'Sekund po',

	pholderAfterBeforeValTODO: 'Wartość',
	pholderAlarmDateTODO: 'Dzień alarmu',
	pholderAlarmTimeTODO: 'Godzina alarmu',

	pholderNoteTODO: 'Uwagi',
	txtNoteTODO: 'Uwagi',

	todoPrevNav: 'Pokaż poprzednie',
	todoNextNav: 'Pokaż następne',
	todoUncompletedPrevNav: 'Pokaż poprzednie nieukończone',
	todoUncompletedNextNav: 'Pokaż następne nieukończone',

	buttonSaveTODO: 'Zapisz',
	buttonEditTODO: 'Edytuj',
	buttonDuplicateTODO: 'Duplikuj',
	buttonResetTODO: 'Wróć',
	buttonCloseTODO: 'Zamknij',
	buttonDeleteTODO: 'Usuń',

	// EVENTS
	pholderName: 'Nazwa',
	pholderNewEvent: 'Nowe wydarzenie',
	txtLocation: 'Lokalizacja',
	pholderLocation: 'Lokalizacja',

	txtAllDay: 'Cały dzień',
	from: 'Od',
	to: 'Do',

	pholderDateFrom: 'Od dnia',
	pholderTimeFrom: 'Od godziny',
	pholderDateTo: 'Do dnia',
	pholderTimeTo: 'Do godziny',

	txtStatusNone: 'Unspecified',
	txtStatusTentative: 'Próbny',
	txtStatusConfirmed: 'Potwierdzony',
	txtStatusCancelled: 'Anulowany',

	txtRepeat: 'Powtórz',
	txtNoRepeat: 'Nie powtarzaj',
	txtRepeatDay: 'Codziennie',
	txtRepeatWeek: 'Co tydzień',
	txtRepeatWeekend: 'W każdy weekend',
	txtRepeatMonth: 'Co miesiąc',
	txtRepeatTwoWeek: 'Co dwa tygodnie',
	txtRepeatYear: 'Co roku',
	txtRepeatCustomWeek: 'Niestandardowy tydzień',
	txtRepeatCustomMonth: 'Niestadardowy miesiąc',
	txtRepeatCustomYear: 'Niestandardowy rok',
	txtRepeatWork: 'Każdego dnia roboczego',
	txtRepeatOnDate: 'Co datę',
	txtRepeatAfter: 'Po wystąpieniu',
	txtRepeatNever: 'Nigdy',
	pholderUntilDate: 'Do dnia',
	pholderRepeatCount: 'Liczba powtórzeń',
	txtRepeatCustomWeekLabel: 'w',
	txtRepeatCustomMonthLabel: 'w dni',
	txtRepeatCustomMonthEvery: 'Każego',
	txtRepeatCustomMonthFirst: 'Pierwszego',
	txtRepeatCustomMonthSecond: 'Drugiego',
	txtRepeatCustomMonthThird: 'Trzeciego',
	txtRepeatCustomMonthFourth: 'Czwartego',
	txtRepeatCustomMonthFifth: 'Piątego',
	txtRepeatCustomMonthLast: 'Ostatniego',
	txtRepeatCustomMonthCustom: 'Niestandardowy',
	txtRepeatCustomMonthMonth: 'Dzień miesiąca',
	txtRepeatCustomYearLabel1: 'każdy',
	txtRepeatCustomYearLabel2: 'z',

	txtRepeatEnd: 'Koniec',
	txtEventCalendar: 'Kalendarz',
	txtSelectCalendar: 'Wybierz kalendarz',
	txtAlert: 'Ostrzeżenie',
	txtAlertNone: 'Nieokreślony',
	txtAlertMessage: 'Wiadomość',
	txtAlertOnDate: 'Dnia',
	txtAlertWeeksBefore: 'Tygodni przed',
	txtAlertDaysBefore: 'Dni przed',
	txtAlertHoursBefore: 'Godzin przed',
	txtAlertMinutesBefore: 'Minut przed',
	txtAlertSecondsBefore: 'Sekund przed',
	txtAlertWeeksAfter: 'Tygodni po',
	txtAlertDaysAfter: 'Dni po',
	txtAlertHoursAfter: 'Godzin po',
	txtAlertMinutesAfter: 'Minut po',
	txtAlertSecondsAfter: 'Sekund po',

	pholderAfterBeforeVal: 'Wartość',
	pholderAlarmDate: 'Data alarmu',
	pholderAlarmTime: 'Czas alarmu',

	pholderNote: 'Uwagi',

	eventPrevNav: 'Pokaż poprzednie wydarzenie',
	eventNextNav: 'Pokaż następne wydarzenie',

	buttonClose: 'Zamknij',
	buttonDuplicate: 'Duplikuj',

	txtAllSavedTodo: 'Sukces, zapisano zadanie ToDo!',
	txtAllSaved: 'Sukces, zapisano wydarzenie!',

	txtAllDeletedTodo: 'Sukces, zadanie ToDo usunięte!',
	txtAllDeleted: 'Sukces, wydarzenie usunięte!',

	txtNotChooseTodo: 'Błąd! Należy wybrać kalendarz.',
	txtNotChoose: 'Błąd! Należy wybrać kalendarz.',

	txtErrorDates: 'Błąd! Początkowa data musi poprzedzać datę końcową.',
	txtErrorDatesTodo: 'Błąd! Początkowa data musi poprzedzać datę końcową.',

	txtErorInputTodo: 'Nie możliwe do zapisania, popraw błędne wartości.',
	txtDateTimeErrorTodo: 'Należy ustawić datę i godzinę.',

	txtErorInput: 'Błąd: \'nie można zapisać\': popraw zaznaczone wartość.',

	txtAlertsH: 'Ostrzeżenia',
	buttonAlert: 'Wyczyść ostrzeżenia',

	altAddEvent: 'Dodaj wydarzenie',
	altAddTodo: 'Dodaj zadanie ToDo',

	loadingCalendars: 'Ładowanie kalendarzy (%act% z %total%) ...',
	unloadingCalendars: 'Rozładowanie kalendarzy ...',

	errUnableSaveBeginCalDAV: 'Błąd: \'nie można zapisać wydarzenia\': %%!',
	errUnableDeleteBeginCalDAV: 'Błąd: \'nie można usunąc wydarzenia\': %%!',
	CalDAVerrHttp410: 'Wydarzenie nie jest już dostępne na serwerze',
	errUnableSaveTodoBeginCalDAV: 'Błąd: \'nie można zapisać zadania ToDo\': %%!',
	errUnableDeleteTodoBeginCalDAV: 'Błąd: \'nie można usunąć zdania ToDo\': %%!',
	CalDAVerrTodoHttp410: 'Zadanie ToDo nie jest już dostępne na serwerze'
};
